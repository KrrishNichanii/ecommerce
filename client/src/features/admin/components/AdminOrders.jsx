            ...
            <table className="min-w-max w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  >
                    Order#
                     {sort._sort === 'id' && (sort._order === 'asc' ? <ArrowUpIcon className='w-4 h-4 inline ml-2'/> 
                     : <ArrowDownIcon className='w-4 h-4 inline ml-2'/>)}
                  </th>
                  ...
                  >
                     Total Amount {' '}
                     {sort._sort === 'totalAmount' && (sort._order === 'asc' ? <ArrowUpIcon className='w-4 h-4 inline ml-2'/> 
                     : <ArrowDownIcon className='w-4 h-4 inline ml-2'/>)}
                  </th>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td className="py-3 px-6 text-center">
                      <div className="">
                        ...
                        <div className="">{order.selectedAddress.street},</div>
                        <div className="">{order.selectedAddress.city},</div>
                        <div className="">{order.selectedAddress.state},</div>
                        <div className="">{order.selectedAddress.pincode},</div>
                        <div className="">{order.selectedAddress.phone},</div>
                      </div>
                    </td>
