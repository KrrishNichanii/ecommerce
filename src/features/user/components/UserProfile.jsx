...
function UserProfile() {
  ...
  const handleEdit = (addressUpdate, index) => {
    const newUser = { ...user, addresses: [...user.addresses] }; //creating shallow copy
  ...
  const handleAdd = (address) => {
    const newUser = { ...user, addresses: [...user.addresses ,address] }; //creating shallow copy
    dispatch(updateUserAsync(newUser));
  ...
  return (
    <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="border-t border-gray-200 px-4 py-6 sm:px-6 ">
        ...
        {user.role === 'admin' && <h3 className="text-xl my-5 font-bold tracking-tight text-red-600">
          role : {user.role}
        </h3>}
      </div>
      ...
      <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
       {!showAddAddressForm ? <button
                ...
                <div className="space-y-12">
                  <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                      Add a permanent address where you can receive mail.
                    </p>
        ...
        <p className="mt-0.5 mb-2 text-sm text-gray-500">Your Addresses :</p>
            ...
            <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200 mb-2">
              ...
              <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                <button
                  ...
                  type="button"
                  className="font-medium mb-2 text-indigo-600 hover:text-indigo-500"
                >
                  Edit
                </button>
                <button
