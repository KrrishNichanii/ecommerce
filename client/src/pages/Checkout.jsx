      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          >
            <div className="space-y-12">
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                <button
                  type="button"
                  className="text-sm font-semibold leading-6 text-gray-900 border hover:border-indigo-600 px-3 py-1.5 rounded-md"
                >
                  Reset
                </button>
                <button
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-4 lg:px-4">
            ...
            <div className="border-t border-gray-200 px-0 py-6 sm:px-2">
